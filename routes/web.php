...
Route::middleware('auth')->group(function() {
    ...
    Route::get('/profil/deletephoto/{user}',[UserController::class,'destroy'])->name('deleteProfilePhoto');
    ...
    Route::get('/tambahuser', [UserController::class,'tambah'])->name('tambahuser');
    Route::post('/submituser', [UserController::class,'add'])->name('useradd');
