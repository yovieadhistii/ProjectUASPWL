                        ...
                        <div class="card-body">
                            <form action="{{ route('updateProfile', ['id' => $user->id])}}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="nama" type="text" placeholder="Enter your username" value="{{$user->nama}}">
                                </div>
                                <!-- Form Row-->
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="phone" type="tel" placeholder="Enter your phone number" value="{{$user->telepon}}">
                                    </div>
                                    <!-- Form Group (birthday)-->
                                    <div class="col-md-6">
