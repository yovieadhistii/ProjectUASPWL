                ...
                <div class="col-xl-4">
                    ...
                    <div class="card mb-4 mb-xl-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <a href="{{ route('deleteProfilePhoto', ['id' => $user->id])}}" class="btn btn-primary"> Delete Image </a>
                            ...
                            <form action="{{ route('updateProfile', ['id' => $user->id])}}" method="post">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputFirstName"  name="kota" type="text" placeholder="Enter your first name" value="{{$user->kota}}">
                                    </div>
                                    <!-- Form Group (last name)-->
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputLastName">Agama</label>
                                        <input class="form-control" id="inputLastName" name="agama" type="text" placeholder="Enter your last name" value="{{$user->agama}}">
                                    </div>
                                </div>
                                <!-- Form Row        -->
                                <div class="mb-3">
                                    <!-- Form Group (organization name)-->
                                        ...
                                        <input class="form-control" id="inputLocation" name="alamat" type="text" placeholder="Enter your location" value="{{$user->alamat}}">
                                </div>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="phone" name="telepon" type="tel" placeholder="Enter your phone number" value="{{$user->telepon}}">
                                    </div>
                                    <!-- Form Group (birthday)-->
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputBirthday">Tanggal Lahir</label>
                                        <input class="form-control" id="inputBirthday" name="tlahir" type="text" name="birthday" placeholder="Enter your birthday" value="{{$user->tanggal_lahir}}">
                                    </div>
                                </div>
                                <!-- Save changes button-->
