        ...
        @foreach($semesters as $semester=>$mk)
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#{{$semester}}" aria-expanded="true" aria-controls="collapseOne">
                            Semester {{$semester}}
                        </button>
                    </h2>
                    <div id="{{$semester}}" class="accordion-collapse collapse show" aria-labelledby="headingOne">
