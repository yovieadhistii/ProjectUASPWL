...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block"><?php echo e(Auth::user()->nama); ?> | <?php echo e(Auth::user()->role); ?></a>
            </div>
        </div>
        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\projectUASPWL\resources\views/layouts/sidebarprodi.blade.php ENDPATH**/ ?>