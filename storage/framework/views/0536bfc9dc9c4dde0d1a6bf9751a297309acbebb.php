                        ...
                        <div class="card-body">
                            <form action="<?php echo e(route('updateProfile', ['id' => $user->id])); ?>" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="nama" type="text" placeholder="Enter your username" value="<?php echo e($user->nama); ?>">
                                </div>
                                <!-- Form Row-->
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="phone" type="tel" placeholder="Enter your phone number" value="<?php echo e($user->telepon); ?>">
                                    </div>
                                    <!-- Form Group (birthday)-->
                                    <div class="col-md-6">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projectUASPWL\resources\views/mahasiswa/editprofil.blade.php ENDPATH**/ ?>